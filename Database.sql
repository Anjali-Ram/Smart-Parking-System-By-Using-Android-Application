...
insert into `bankdetails` (`name`,`accountno`,`cvv`,`expirydate`,`password`) values 
('sri','1234567890','999','12/2024','asdf');
...
insert into `user` (`username`,`password`,`mail`,`mobile`) values 
('sri','asdf',NULL,'9884113466');
